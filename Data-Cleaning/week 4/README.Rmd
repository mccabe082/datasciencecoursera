...
A supplementary **meanSummary** datastructure is also provided.  This shows the mean value of each feature variable for each different form of activity.  e.g. ...

```{r cars}
source("run_analysis.R")
meanSummary[3] # mean(tBodyAcc-mean()-Y)
```